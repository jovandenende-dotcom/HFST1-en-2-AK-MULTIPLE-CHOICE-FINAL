...
{
  question: "Wat is de bovenloop?",
  options: [
    "De riviermonding",
    "Het deel met groot verval en veel erosie",
    "Het deel met veel sedimentatie",
    "Het deel in zee"
  ],
  answer: 1
},
{
  question: "Wat is de benedenloop?",
  options: [
    "Het deel met groot verval",
    "Het deel met geringe stroomsnelheid en veel sedimentatie",
    "Het deel bij de bron",
    "Het deel in de bergen"
  ],
  answer: 1
},
{
